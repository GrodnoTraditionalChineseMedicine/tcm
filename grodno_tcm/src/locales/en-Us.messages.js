const En = {
    ...
    'components.header.learn': 'Learning CTM',
    ...
    'privacy.version.head': '<p>Grodno TCM Center （And "we", "our" or "this app" mentioned below.）is composed of main bodyThe company甘肃省中医院格罗德诺中医中心The network product that offers。' +
        ...
        '<p>Unless otherwise specified in this privacy policy, terms used in this privacy policy have the same meaning as our terms and conditions.Can be inGrodno TCM CenterIn the access.</p>',
    ...
    'privacy.version.content10':'<h3>10. Support</h3>' +
        ...
        '</br>By email:xinghanluo@gmail.com    </br>By link:    </br>By telephone:+375 29 848 45 84</p>',
